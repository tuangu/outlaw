...
public class Map {
    ...
    private void setLocation() {
        location.put(1, "Location A");
        location.put(2, "Location B");
        location.put(3, "Location C");
        location.put(4, "Location E");
        location.put(5, "Location F");
        location.put(6, "Location G");
        location.put(7, "Location H");
        location.put(8, "Location J");
        location.put(9, "Location K");
    }
